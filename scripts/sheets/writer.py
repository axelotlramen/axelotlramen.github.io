...
class SheetWriter:
    ...
    async def build_rows(self, mode: ChallengeMode) -> list[SheetRow]:
        ...
        Boss/mini-boss identity is never auto-filled here - the Boss column is purely
        manual, carried forward from the previous sheet state by _preserve_manual_entries
        in sheets_client.py, and left blank on a brand new row."""
        match mode:
